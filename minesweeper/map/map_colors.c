...
static void	init_pairs(void)
{
	...
	init_pair(8, MY_DARK_BLUE, MY_FONT); // color 4
	init_pair(9, MY_DARK_BLUE, MY_WHITE);
...
void	init_colors(void)
{
	...
	init_color(MY_GREEN, 0, 502, 0);
	init_color(MY_RED, 1000, 0, 0);
	init_color(MY_DARK_BLUE, 0, 0, 502);
	init_color(MY_BROWN, 502, 0, 0);
